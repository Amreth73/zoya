document.addEventListener("DOMContentLoaded", function () {
                    ...
                    <td>${
                      media.length > 0
                        ? media
                            .map(
                              (m) =>
                                `<img src="${m}" alt="Product Image" style="width:50px;height:50px;">`
                            )
                            .join("")
                        : "No Media"
                    }</td>
  ...
  function toggleActionButtons() {
    const anyChecked =
      document.querySelectorAll(".product-checkbox:checked").length > 0;
...
document
  .querySelector('button[onclick="deleteSelectedProducts()"]')
